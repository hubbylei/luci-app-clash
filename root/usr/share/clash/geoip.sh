...
wget -c4 --no-check-certificate --timeout=300 --user-agent="Mozilla" https://raw.fastgit.org/alecthw/mmdb_china_ip_list/release/Country.mmdb -O /etc/clash/Country.mmdb
fi
